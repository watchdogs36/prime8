...
# UserLists WolfGirl Movies
        self.wgaction_link = 'https://www.imdb.com/list/ls044844213/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.wgapocolypse_link = 'https://www.imdb.com/list/ls044846463/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.wgcomedy_link = 'https://www.imdb.com/list/ls044846446/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.wgdocs_link = 'https://www.imdb.com/list/ls093271498/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%dstart=1' % self.count
        self.wgmonster_link = 'https://www.imdb.com/list/ls044849542/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%dstart=1' % self.count
...
# UserLists ShadowHawks Movies
        ...
        self.shstonermovies_link = 'https://www.imdb.com/list/ls093291705/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.shmontypython_link = 'https://www.imdb.com/list/ls093293549/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.shchechchong_link = 'https://www.imdb.com/list/ls093297505/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count

# UserLists DocOctyl
        self.dosyfy_link = 'https://www.imdb.com/list/ls096704404/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.dodrivein_link = 'https://www.imdb.com/list/ls096764156/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
        self.douniverse_link = 'https://www.imdb.com/list/ls096764530/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%d&start=1' % self.count
...
# User Lists U53R5
        ...
        self.genreaction_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=action&sort=moviemeter,asc&count=50&start=1'
        self.genreadventure_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=adventure&sort=moviemeter,asc&count=50&start=1'
        self.genreanimation_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=animation&sort=moviemeter,asc&count=50&start=1'
        self.genreanime_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=anime&sort=moviemeter,asc&count=50&start=1'
        self.genrebiography_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=biography&sort=moviemeter,asc&count=50&start=1'
        self.genrecomedy_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=comedy&sort=moviemeter,asc&count=50&start=1'
        self.genrecrime_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=crime&sort=moviemeter,asc&count=50&start=1'
        self.genredocumentary_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=documentary&sort=moviemeter,asc&count=50&start=1'
        self.genredrama_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=drama&sort=moviemeter,asc&count=50&start=1'
        self.genrefamily_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=family&sort=moviemeter,asc&count=50&start=1'
        self.genrefantasy_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=fantasy&sort=moviemeter,asc&count=50&start=1'
        self.genrehistory_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=history&sort=moviemeter,asc&count=50&start=1'
        self.genrehorror_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=horror&sort=moviemeter,asc&count=50&start=1'
        self.genremusic_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=music&sort=moviemeter,asc&count=50&start=1'
        self.genremusical_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=musical&sort=moviemeter,asc&count=50&start=1'
        self.genremystery_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=mystery&sort=moviemeter,asc&count=50&start=1'
        self.genreromance_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=romance&sort=moviemeter,asc&count=50&start=1'
        self.genrescifi_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=sci_fi&sort=moviemeter,asc&count=50&start=1'
        self.genresport_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=sport&sort=moviemeter,asc&count=50&start=1'
        self.genrethriller_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=thriller&sort=moviemeter,asc&count=50&start=1'
        self.genrewar_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=war&sort=moviemeter,asc&count=50&start=1'
        self.genrewestern_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[360]&genres=western&sort=moviemeter,asc&count=50&start=1'

        self.played1_link = 'https://api.trakt.tv/movies/played/weekly?page=1&limit=%d' % self.count
        self.played2_link = 'https://api.trakt.tv/movies/played/monthly?page=1&limit=%d' % self.count
        self.played3_link = 'https://api.trakt.tv/movies/played/yearly?page=1&limit=%d' % self.count
        self.played4_link = 'https://api.trakt.tv/movies/played/all?page=1&limit=%d' % self.count
        self.collected1_link = 'https://api.trakt.tv/movies/collected/weekly?page=1&limit=%d' % self.count
        self.collected2_link = 'https://api.trakt.tv/movies/collected/monthly?page=1&limit=%d' % self.count
        self.collected3_link = 'https://api.trakt.tv/movies/collected/yearly?page=1&limit=%d' % self.count
        self.collected4_link = 'https://api.trakt.tv/movies/collected/all?page=1&limit=%d' % self.count
        self.watched1_link = 'https://api.trakt.tv/movies/watched/weekly?page=1&limit=%d' % self.count
        self.watched2_link = 'https://api.trakt.tv/movies/watched/monthly?page=1&limit=%d' % self.count
        self.watched3_link = 'https://api.trakt.tv/movies/watched/yearly?page=1&limit=%d' % self.count
        self.watched4_link = 'https://api.trakt.tv/movies/watched/all?page=1&limit=%d' % self.count
...
####################################
                ...
                if is_widget:
                    item.setProperty('isWatchdogs_widget', 'true')
        ...
        if next:
            try:
                ...
                nextMenu = '[COLOR magenta]' + nextMenu + page + '[/COLOR]'

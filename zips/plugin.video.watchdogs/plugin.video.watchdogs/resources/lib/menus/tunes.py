...
class radionet:
    ...
    def root(self):
        try:
            self.addDirectoryItem('Top 100 Stations', 'radio&url=tophundred', 'radio.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('Local Stations', 'radio&url=localstations', 'radio.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('Recommended', 'radio&url=recommended', 'radio.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('Language', 'radioCat&url=language', 'radio.png', 'DefaultVideoPlaylists.png')
            self.endDirectory()
        except Exception:
            pass

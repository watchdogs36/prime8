...
class Navigator:
    ...
    def userlists(self, lite=False):
        ...
        self.addDirectoryItem('Random', 'U53R4nav', 'random.png', 'DefaultMovies.png')
    ...
    def random(self, lite=False):
        ...
        self.addDirectoryItem('2000s Top 100 Movies', 'movies&url=top100', 'icon.png', 'DefaultMovies.png')  
        self.endDirectory()

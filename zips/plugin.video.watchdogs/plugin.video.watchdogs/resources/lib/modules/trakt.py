...
V2_API_KEY = 'd89fddced6ceffdd2d090d93d87c25b4893b9ed7a1bf043f52c8b15fe3636904'
CLIENT_SECRET = '26f304280bea1bed2c7cb1272ebadfed77935cf1179922dcd3a58512a2a90aef'
            ...
            if len(items) > 0:
                ...
                if item:
                    ...
                    data = {
                        type : item,
                        'progress': progress,
                        'app_version': control.addonVersion(addon='plugin.video.watchdogs'),
                    }

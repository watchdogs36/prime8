...
def _find_cache_version():
    ...
    try:
        ...
        ad_folder = control.transPath('special://home/userdata/addon_data/plugin.video.watchdogs')
    ...
    try:
        curVersion = control.addon('plugin.video.watchdogs').getAddonInfo('version')

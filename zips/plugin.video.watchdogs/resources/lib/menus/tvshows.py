...
class TVshows:
    def __init__(self, type = 'show', notifications = True):
        ...
        self.traktanticipated_link = 'https://api.trakt.tv/shows/anticipated?limit=%d&page=1' % self.count
        ...
        self.genreaction_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=action&sort=moviemeter,asc&count=50&start=1'
        self.genreadventure_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=adventure&sort=moviemeter,asc&count=50&start=1'
        self.genreAnimation_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=animation&sort=moviemeter,asc&count=50&start=1'
        self.genreAnime_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=anime&sort=moviemeter,asc&count=50&start=1'
        self.genreBiography_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=biography&sort=moviemeter,asc&count=50&start=1'
        self.genreComedy_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=comedy&sort=moviemeter,asc&count=50&start=1'
        self.genreCrime_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=crime&sort=moviemeter,asc&count=50&start=1'
        self.genreDocumentary_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=documentary&sort=moviemeter,asc&count=50&start=1'
        self.genreDrama_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=drama&sort=moviemeter,asc&count=50&start=1'
        self.genreFamily_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=family&sort=moviemeter,asc&count=50&start=1'
        self.genreFantasy_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=fantasy&sort=moviemeter,asc&count=50&start=1'
        self.genreHistory_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=history&sort=moviemeter,asc&count=50&start=1'
        self.genreHorror_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=horror&sort=moviemeter,asc&count=50&start=1'
        self.genreMusic_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=music&sort=moviemeter,asc&count=50&start=1'
        self.genreMusical_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=musical&sort=moviemeter,asc&count=50&start=1'
        self.genreMystery_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=mystery&sort=moviemeter,asc&count=50&start=1'
        self.genreRomance_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=romance&sort=moviemeter,asc&count=50&start=1'
        self.genrescifi_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sci_fi&sort=moviemeter,asc&count=50&start=1'
        self.genreSport_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sport&sort=moviemeter,asc&count=50&start=1'
        self.genreThriller_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=thriller&sort=moviemeter,asc&count=50&start=1'
        self.genreWar_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=war&sort=moviemeter,asc&count=50&start=1'
        self.genreWestern_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=western&sort=moviemeter,asc&count=50&start=1'
        self.genretalk_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=talk_show&sort=moviemeter,asc&count=50&start=1'
        self.genrereality_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=reality_tv&sort=moviemeter,asc&count=50&start=1'
        self.genrenews_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[360]&genres=news&sort=moviemeter,asc&count=50&start=1'

        self.played1_link = 'https://api.trakt.tv/shows/played/weekly?page=1&limit=%d' % self.count
        self.played2_link = 'https://api.trakt.tv/shows/played/monthly??page=1&limit=%d' % self.count
        self.played3_link = 'https://api.trakt.tv/shows/played/yearly?page=1&limit=%d' % self.count
        self.played4_link = 'https://api.trakt.tv/shows/played/all?page=1&limit=%d' % self.count
        self.collected1_link = 'https://api.trakt.tv/shows/collected/weekly?page=1&limit=%d' % self.count
        self.collected2_link = 'https://api.trakt.tv/shows/collected/monthly?page=1&limit=%d' % self.count
        self.collected3_link = 'https://api.trakt.tv/shows/collected/yearly?page=1&limit=%d' % self.count
        self.collected4_link = 'https://api.trakt.tv/shows/collected/all?page=1&limit=%d' % self.count
        self.watched1_link = 'https://api.trakt.tv/shows/watched/weekly?page=1&limit=%d' % self.count
        self.watched2_link = 'https://api.trakt.tv/shows/watched/monthly?page=1&limit=%d' % self.count
        self.watched3_link = 'https://api.trakt.tv/shows/watched/yearly?page=1&limit=%d' % self.count
        self.watched4_link = 'https://api.trakt.tv/shows/watched/all?page=1&limit=%d' % self.count

# User Lists ShadowHawks Tv
        self.shstonertvshows_link = 'https://www.imdb.com/list/ls093291259/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&&count=%d&start=1' % self.count
